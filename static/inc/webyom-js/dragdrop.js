 ...
 */
YOM.dragdrop.addModule('Draggable', function(YOM) {
 ...
 */
YOM.dragdrop.addModule('Droppable', function(YOM) {
 ...
 */
YOM.dragdrop.addModule('Sortable', function(YOM) {
	...
	Sortable.prototype = $extend(Sortable.prototype, {
		...
		_enter: function(e) {
			...
			if(isBox && $.Element.contains(e.dropbox.get(), e.oriEl.get())) {
				return;
			}
 ...
 */
YOM.dragdrop.addModule('Resizeable', function(YOM) {
